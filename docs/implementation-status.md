...
**Siguiente ítem habilitado:** US-002 — Representar dinero y redondeo de forma decimal

| Épica | Planeado | Listo | En curso | Bloqueado | Completado |
| --- | ---: | ---: | ---: | ---: | ---: |
| E1 · Motor financiero verificable | 5 | 1 | 0 | 0 | 1 |
...
| US-002 | E1 · Motor financiero verificable | Representar dinero y redondeo de forma decimal | Listo | US-001 |
