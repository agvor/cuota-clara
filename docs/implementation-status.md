...
**Siguiente ítem habilitado:** US-004 — Generar amortización de cuota periódica fija

| Épica | Planeado | Listo | En curso | Bloqueado | Completado |
| --- | ---: | ---: | ---: | ---: | ---: |
| E1 · Motor financiero verificable | 3 | 1 | 0 | 0 | 3 |
...
| US-004 | E1 · Motor financiero verificable | Generar amortización de cuota periódica fija | Listo | US-003 |
