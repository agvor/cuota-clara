...
**Siguiente ítem habilitado:** US-001 — Establecer casos de referencia financieros

| Épica | Planeado | Listo | En curso | Bloqueado | Completado |
| --- | ---: | ---: | ---: | ---: | ---: |
| E1 · Motor financiero verificable | 6 | 1 | 0 | 0 | 0 |
...
| --- | --- | --- | --- | --- |
| US-001 | E1 · Motor financiero verificable | Establecer casos de referencia financieros | Listo | — |
| US-002 | E1 · Motor financiero verificable | Representar dinero y redondeo de forma decimal | Planeado | US-001 |
| US-003 | E1 · Motor financiero verificable | Resolver una tasa fija por periodo | Planeado | US-002 |
