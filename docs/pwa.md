...
La tabla de amortización y el gráfico se montan solo al seleccionar **Ver detalle de amortización**. La tabla alterna el orden cronológico por fecha y conserva paginación. El gráfico ofrece rangos de 12, 60, 120 períodos o todo el plazo, con ejes temporal y monetario, cuadrícula, etiquetas compactas y un punto enfocable/inspeccionable que muestra fecha, pago, interés, principal y saldo. Véase [`domain/contract-payment-and-results-v3.md`](domain/contract-payment-and-results-v3.md).
