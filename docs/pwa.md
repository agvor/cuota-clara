...
La próxima revisión de la PWA aplicará formato monetario universal y separará el resumen del detalle bajo demanda. Véase [`domain/contract-payment-and-results-v3.md`](domain/contract-payment-and-results-v3.md).
