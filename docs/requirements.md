...
| RF-010 | Visualizar resultados.                  | El resumen se muestra primero; tabla paginada ordenable por fecha y gráfico con ejes, cuadrícula, señales seleccionables, detalle agrupado por fuente y punto fijable se solicitan bajo demanda. | Completado |
