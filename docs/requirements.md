...
| RF-010 | Visualizar resultados.                  | El resumen se muestra primero; tabla paginada ordenable por fecha y gráfico con ejes, cuadrícula, señales seleccionables, tabla comparativa del punto y punto fijable se solicitan bajo demanda. | Completado |
