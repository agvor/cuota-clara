...
| RF-004 | Calcular una proyección base.           | Para cada periodo se muestran saldo inicial/final, tasa, cuota, seguro, interés, principal y pago total; el resultado es determinista, puede calcular la cuota automática y puede iniciar desde un reset bancario confirmado.                                                                              | En curso   |
