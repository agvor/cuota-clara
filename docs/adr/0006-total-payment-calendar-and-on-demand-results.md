...
- Estado: aceptado para planificar; pendiente de implementación en US-021 a US-023
- Fecha: 2026-07-29
...
1. El próximo contrato guarda `monthlyTotalPayment` y `monthlyInsurance`. La cuota base se deriva como `monthlyTotalPayment − monthlyInsurance`; debe ser positiva y es la única parte disponible para interés y principal.
