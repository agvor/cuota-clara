...
4. Produce saldo final, importes y traza de tasa.

## Contrato de salida

Cada periodo contiene fecha, saldo inicial, tasa anual y periódica, interés, principal, cargos, pago y saldo final. En esta entrega los cargos son siempre `0.00`; seguros, comisiones y cargos configurables requerirán reglas y casos de referencia propios.
