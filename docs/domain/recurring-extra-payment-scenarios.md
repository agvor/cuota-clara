...
La tabla de amortización tiene una fuente única seleccionable. Abre en la configuración base y permite elegir cualquier escenario compatible para sustituir únicamente sus filas proyectadas; los registros históricos permanecen visibles porque no se modifican al simular una alternativa.
